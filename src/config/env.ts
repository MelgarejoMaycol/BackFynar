...
const schema = z.object({
  ...
  JWT_ISSUER: z.string().min(1).default("veloryx-api"),
  JWT_AUDIENCE: z.string().min(1).default("veloryx-clients"),
  ...
  EMAIL_FROM: z.string().min(1).default("Veloryx <no-reply@example.invalid>"),
